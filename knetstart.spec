...
Ten program KDE jest prostym konfiguratorem sieci. Potrzebuje znać
najwyżej 3 adresy IP. KNetstart nie tylko konfiguruje lokalny
komputer, może także sprawdzić bramkę i serwer DNS. Podczas
poszukiwania wyświetla się animacja.

KNetstart ma wbudowanego klienta DHCP bazującego na pump 0.6.7. Ten
klient może automatycznie ustawić kartę używając protokołu DHCP. Adres
IP, maska sieci, adres bramki i serwerów DNS są brane z serwera i
